...
//    private static final String OWM_LIST = "list";
    private static final String OWM_LIST="daily";

    private static final String OWM_PRESSURE = "pressure";
    private static final String OWM_HUMIDITY = "humidity";
//    private static final String OWM_WINDSPEED = "speed";
private static final String OWM_WINDSPEED = "wind_speed";
    //private static final String OWM_WIND_DIRECTION = "deg";
    private static final String OWM_WIND_DIRECTION = "wind_deg";
...
//        double cityLongitude = cityCoord.getDouble(OWM_LONGITUDE);
        ...
        Log.i("OpenWeatherJsonUtils####","Latitude and Longitude are "+cityLatitude+" "+cityLongitude);

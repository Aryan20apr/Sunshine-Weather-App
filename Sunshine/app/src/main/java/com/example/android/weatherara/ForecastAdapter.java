...
import com.example.android.weatherara.utilities.SunshineWeatherUtils;
...
//        view.setFocusable(true);
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        switch(viewType) {
            //If the view type of the layout is today, display a a large icon
            case VIEW_TYPE_TODAY:
...
//                .getSmallArtResourceIdForWeatherCondition(weatherId);
        ...
        Log.i("ForecastAdapter"+"###","Date String is "+dateString);

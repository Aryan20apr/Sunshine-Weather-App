...
public final class SunshinePreferences {
    private static String TAG=SunshinePreferences.class.getSimpleName();
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        Log.i("TAG"+"@#"," Location is "+sp.getString(keyForLocation,defaultLocation));
    ...
    public static boolean areNotificationsEnabled(Context context)
    {
         ...
         */
        boolean shouldDisplayNotificationByDefault=context.getResources().getBoolean(R.bool.show_notification_by_default);
        /* As usual, we use the default SharedPreferences to access the user's preferences */
        SharedPreferences sp= androidx.preference.PreferenceManager.getDefaultSharedPreferences(context);
        /*If a value is stored with the key, we extract it here. If not, use a default.*/
        boolean shoulddisplayNotification=sp.getBoolean(displayNotificationsKey,shouldDisplayNotificationByDefault);

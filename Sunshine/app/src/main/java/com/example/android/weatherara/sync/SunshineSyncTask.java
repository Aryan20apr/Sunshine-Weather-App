package com.example.android.weatherara.sync;//  TODO (1) Create a class called SunshineSyncTask
...
import com.example.android.weatherara.utilities.NetworkUtils;
import com.example.android.weatherara.utilities.NotificationUtils;
import com.example.android.weatherara.utilities.OpenWeatherJsonUtils;
...
public class SunshineSyncTask extends Worker
{
    ...
    synchronized public static void syncWeather(Context context)
    {
        ...
        try
        {
            ...
            Log.i(TAG+"###","URL="+weatherRequestUrl);

            //use the URL to retrieve the JSON
            String jsonWeatherResponse= NetworkUtils.getResponseFromHttpUrl(weatherRequestUrl);
            Log.i(TAG+"###","Response="+jsonWeatherResponse);
        ...
        if(timeSinceLastNotification>= 900000)//DateUtils.DAY_IN_MILLIS)
        {

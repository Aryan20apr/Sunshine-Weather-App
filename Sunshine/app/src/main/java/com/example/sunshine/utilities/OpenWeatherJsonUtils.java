...
public class OpenWeatherJsonUtils
{
    ...
    public static String[] getSimpleWeatherStringsFromJson(Context context,String forecastJsonStr)throws JSONException {
        ...
        long localDate = System.currentTimeMillis();//The currentTimeMillis() method of System class returns current time in format of millisecond. Millisecond will be returned as unit of time.
